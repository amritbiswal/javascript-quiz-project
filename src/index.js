document.addEventListener("DOMContentLoaded", () => {
  ...
  // startTimer() - Starts the quiz countdown timer
  // stopTimer() - Stops the quiz countdown timer
  ...
  function showQuestion() {
    ...
    questionContainer.innerText = question.text; // Example placeholder
    ...
    question.choices.forEach((choice) => {
      ...
      // listItem.innerHTML = `<input type="radio" name="choice" value="${choice}"> <label>${choice}</label>`;
